...
export function Button({
  ...
  const variantClasses = {
    primary: 'bg-[#1F7A4D] text-white hover:bg-[#1B5E20] border border-[#1F7A4D] focus:ring-[#1F7A4D]',
    secondary: 'bg-transparent text-[#1F7A4D] hover:bg-[#1F7A4D]/20 border border-[#1F7A4D] focus:ring-[#1F7A4D]',
    danger: 'bg-danger-500 text-white hover:bg-danger-600 hover:shadow-lg focus:ring-danger-500',
    ghost: 'bg-transparent text-[#1F7A4D] hover:bg-[#1F7A4D]/20 focus:ring-[#1F7A4D]',
  };
